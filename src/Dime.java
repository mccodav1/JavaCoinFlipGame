/**
 * Returns an object of type 'Dime' representing a dime.
 * Contains value of dime (10) and side of coin facing up ("Heads" or "Tails")
 * @author David McConnell & David Huson
 * @since 03/02/2020
 */
public class Dime {
	private int value = 10;						// Value of the coin 
